Extension: 		AsHealthcareServiceSupportedCapacityExtension
Id: 			as-ext-healthcareservice-supported-capacity
Title:			"AS HealthcareService Supported Capacity Extension"
