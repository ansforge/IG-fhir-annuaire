...
* extension[serialNumber] ^comment = "Synonyme : numeroSerie ; format de codage des caractères en binaire codé en ASCII."
// dNEmetteur
...
* extension[issuer] ^comment = "Synonyme : dNEmetteur ; le format respecte le standard RFC-4514, avec un codage des caractères en UTF8"
// dNSujet
* extension[subject] ^short = "dNSujet"
* extension[subject] ^short = "DN (Distinguished Name - Nom distinctif) du porteur du certificat"
* extension[subject] ^comment = "Synonyme : dNSujet ; codage des caractères en UTF8"
* extension[subject].value[x] only string
// periodValidite
* extension[validity] ^short = "Période de validité du certificat."
* extension[validity] ^comment = "Synonyme : periodValidite ; la date est en UTC (avec translation de l'heure locale en heure UTC par ajout du décalage négatif ou retranchement du décalage positif)."
...
* extension[domain] ^comment = "Synonyme : domaine ; renseigné uniquement pour les certificats logiciels de portée Structure."
...
* extension[value] ^comment = "Synonyme : valeurBinaire ; format .crt en hexadécimal, codé en ASCII"
