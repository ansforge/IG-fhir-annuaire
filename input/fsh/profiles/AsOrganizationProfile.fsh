...
* extension[mailboxMSS] only AsMailboxMSSExtension
...
* type[secteurActiviteRASS] ^sliceName = "secteurActiviteRASS"
...
* type[categorieEtablissementRASS] ^sliceName = "categorieEtablissementRASS"
