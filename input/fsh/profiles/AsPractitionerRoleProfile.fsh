...
* extension contains
	...
	AsPractitionerRoleEndCauseExtension named as-ext-practitionerrole-end-cause 0..* MS and // motif de fin d’activité, renseigné si period.end not null
	AsPractitionerRoleContracted named as-ext-practitionerrole-contracted 0..* MS and // secteur de conventionnement
	AsPractitionerRoleHasCas named as-ext-practitionerrole-hascas 0..* MS and // Option pratique tarifaire maîtrisée
	AsPractitionerRoleVitaleAccepted named as-ext-practitionerrole-vitale-accepted 0..* MS // Indicateur carte Vitale acceptée
