# AS Organization Authorization Deadline Extension - Annuaire Santé v1.2.0-snapshot-1
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-ext-organization-authorization-deadline)
...
Extension complexe: Extension créée dans le cadre de l'Annuaire Santé pour prise en compte de la caducité de l'autorisation sanitaire.
...
Autres représentations du profil : [CSV](../StructureDefinition-as-ext-organization-authorization-deadline.csv), [Excel](../StructureDefinition-as-ext-organization-authorization-deadline.xlsx), [Schematron](../StructureDefinition-as-ext-organization-authorization-deadline.sch) 
