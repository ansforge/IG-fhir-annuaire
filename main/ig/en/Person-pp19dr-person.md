# pp19dr-person - Annuaire Santé v1.2.0-snapshot-3
...
Profile: [AS Donnée Restreinte Person Profile](StructureDefinition-as-dr-person.md)
...
```json
{
  ...
  "id" : "pp19dr-person",
  "meta" : {
    "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-dr-person"]
  },
  "extension" : [{
