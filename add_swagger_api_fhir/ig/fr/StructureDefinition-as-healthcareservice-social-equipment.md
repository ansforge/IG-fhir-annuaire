# AS HealthcareService Social Equipment Profile - Annuaire Santé v1.2.0-snapshot-3

## Profil de ressource: AS HealthcareService Social Equipment Profile 
...
* Dérivé de ce Profil: [AS Donnée Publique HealthcareService Social Equipment Profile](StructureDefinition-as-dp-healthcareservice-social-equipment.md) and [AS Donnée Restreinte HealthcareService Social Equipment Profile](StructureDefinition-as-dr-healthcareservice-social-equipment.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-healthcareservice-social-equipment)
...
Cette structure est dérivée de [HealthcareService](http://hl7.org/fhir/R4/healthcareservice.html) 
...
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-authorization|1.2.0-snapshot-3](StructureDefinition-as-ext-authorization.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-installation|1.2.0-snapshot-3](StructureDefinition-as-ext-installation.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-patient-type|1.2.0-snapshot-3](StructureDefinition-as-ext-patient-type.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-supported-capacity|1.2.0-snapshot-3](StructureDefinition-as-ext-supported-capacity.md)
...
* The element 1 is sliced based on the value of HealthcareService.type
...
Autres représentations du profil : [CSV](../StructureDefinition-as-healthcareservice-social-equipment.csv), [Excel](../StructureDefinition-as-healthcareservice-social-equipment.xlsx), [Schematron](../StructureDefinition-as-healthcareservice-social-equipment.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-authorization|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-installation|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-patient-type|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-supported-capacity|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j379-activite-sociale-regulee-rass|20260223120000"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j376-public-activite-smsse-regulee-rass|20260223120000"
      },
      "mapping" : [{
        "identity" : "as-healthcare-social-equipment-to-mos-activite-sociale",
