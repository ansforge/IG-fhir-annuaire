# AS Supported Capacity Extension - Annuaire Santé v1.2.0-snapshot-3
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-ext-supported-capacity)
...
Extension complexe: Extension créée dans le cadre de l'Annuaire Santé pour indiquer le nombre de personnes pouvant être accueillies en même temps et les capacités d'hébergement.
...
Autres représentations du profil : [CSV](../StructureDefinition-as-ext-supported-capacity.csv), [Excel](../StructureDefinition-as-ext-supported-capacity.xlsx), [Schematron](../StructureDefinition-as-ext-supported-capacity.sch) 
