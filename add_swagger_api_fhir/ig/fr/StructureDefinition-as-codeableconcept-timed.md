# AS CodeableConceptTimed Datatype Profile - Annuaire Santé v1.2.0-snapshot-3
...
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-codeableconcept-timed-metadata|1.2.0-snapshot-3](StructureDefinition-as-ext-codeableconcept-timed-metadata.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-codeableconcept-timed-metadata|1.2.0-snapshot-3"]
      }]
    }]
  }
}
