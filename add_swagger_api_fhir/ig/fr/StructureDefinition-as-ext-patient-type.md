# AS Patient Type Extension - Annuaire Santé v1.2.0-snapshot-3
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-ext-patient-type)
...
Extension complexe: Extension créée dans le cadre de l'Annuaire Santé pour décrire un ensemble de personnes qui répondent à des critères leur permettant de bénéficier de la discipline décrite.
...
Autres représentations du profil : [CSV](../StructureDefinition-as-ext-patient-type.csv), [Excel](../StructureDefinition-as-ext-patient-type.xlsx), [Schematron](../StructureDefinition-as-ext-patient-type.sch) 
