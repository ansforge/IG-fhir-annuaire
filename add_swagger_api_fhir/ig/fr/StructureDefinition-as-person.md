# AS Person Profile - Annuaire Santé v1.2.0-snapshot-3
...
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-person-birth-place|1.2.0-snapshot-3](StructureDefinition-as-ext-person-birth-place.md)
* [http://hl7.org/fhir/5.0/StructureDefinition/extension-Person.deceasedDateTime|1.2.0-snapshot-3](StructureDefinition-as-ext-person-deceased-date-time.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-person-birth-place|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-person-to-mos-personne-physique",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/5.0/StructureDefinition/extension-Person.deceasedDateTime|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-person-to-mos-personne-physique",
