# AS HealthcareService HealthCare Activity Profile - Annuaire Santé v1.2.0-snapshot-3

## Profil de ressource: AS HealthcareService HealthCare Activity Profile 
...
* Dérivé de ce Profil: [AS Donnée Publique HealthcareService Healthcare Activity Profile](StructureDefinition-as-dp-healthcareservice-healthcare-activity.md) and [AS Donnée Restreinte HealthcareService Healthcare Activity Profile](StructureDefinition-as-dr-healthcareservice-healthcare-activity.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-healthcareservice-healthcare-activity)
...
Autres représentations du profil : [CSV](../StructureDefinition-as-healthcareservice-healthcare-activity.csv), [Excel](../StructureDefinition-as-healthcareservice-healthcare-activity.xlsx), [Schematron](../StructureDefinition-as-healthcareservice-healthcare-activity.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J134-FormeActivite-RASS/FHIR/JDV-J134-FormeActivite-RASS|20240628120000"
      }
    }]
  }
}
