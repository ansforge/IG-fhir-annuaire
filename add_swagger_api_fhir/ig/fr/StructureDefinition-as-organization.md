# AS Organization Profile - Annuaire Santé v1.2.0-snapshot-3

## Profil de ressource: AS Organization Profile 
...
Cette structure est dérivée de [FRCoreOrganizationEtablissementProfile](https://hl7.fr/ig/fhir/core/2.2.0/StructureDefinition-fr-core-organization-etablissement.html) 
...
Obligatoire : 0 élément(16 éléments obligatoire(s) imbriqué(s))

**Structures**

Cette structure fait référence à ces autres structures:

* [AS Mailbox MSS Datatype Profile (https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-mailbox-mss|1.2.0-snapshot-3)](StructureDefinition-as-mailbox-mss.md)
...
* [AS Organization Profile (https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-organization|1.2.0-snapshot-3)](StructureDefinition-as-organization.md)

**Extensions**

Cette structure fait référence à ces extensions:

* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-digital-certificate|1.2.0-snapshot-3](StructureDefinition-as-ext-digital-certificate.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-pharmacy-licence|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-pharmacy-licence.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-pricing-model|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-pricing-model.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-closing-type|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-closing-type.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-budget-type|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-budget-type.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-authorization-deadline|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-authorization-deadline.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-types|1.2.0-snapshot-3](StructureDefinition-as-ext-organization-types.md)

**Slices**

Cette structure définit les [slices](http://hl7.org/fhir/R4/profiling.html#slices) suivantes:

* The element 2 is sliced based on the values of Organization.telecom
...
Autres représentations du profil : [CSV](../StructureDefinition-as-organization.csv), [Excel](../StructureDefinition-as-organization.xlsx), [Schematron](../StructureDefinition-as-organization.sch) 
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-16T13:58:22+00:00",
  ...
  "abstract" : false,
  "type" : "Organization",
  "baseDefinition" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization-etablissement|2.2.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-digital-certificate|1.2.0-snapshot-3"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-pharmacy-licence|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-ej",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-pricing-model|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-closing-type|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-ej",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-budget-type|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-authorization-deadline|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "short" : "Type d’identifiant national de l’organisation"
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-organization-types|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J101-SecteurActivite-RASS/FHIR/JDV-J101-SecteurActivite-RASS|20260223120000"
      },
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J129-CategorieEtablissement-RASS/FHIR/JDV-J129-CategorieEtablissement-RASS|20260223120000"
      },
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J100-FinessStatutJuridique-RASS/FHIR/JDV-J100-FinessStatutJuridique-RASS|20200424120000"
      },
      "mapping" : [{
        "identity" : "as-organization-to-mos-ej",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J162-ESPIC-RASS/FHIR/JDV-J162-ESPIC-RASS|20210528120000"
      },
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/annuaire/ValueSet/as-vs-type-etablissement|1.2.0-snapshot-3"
      },
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "ContactPoint",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-mailbox-mss|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-ej",
    ...
    },
    {
      ...
      "type" : [{
        ...
        "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-organization|1.2.0-snapshot-3"]
      }],
      "mapping" : [{
        "identity" : "as-organization-to-mos-eg",
