# AS Mailbox Metadata - Annuaire Santé v1.2.0-snapshot-3
...
* Utilise ce/t/te Extension: [AS Mailbox MSS Datatype Profile](StructureDefinition-as-mailbox-mss.md)
* Exemples pour ce/t/te Extension: [PHARMACIE NOLOT](Organization-481677.md), [CHRU NANCY - HOPITAUX DE BRABOIS](Organization-example-organization-nancy.md) and [Practitioner/3719500](Practitioner-3719500.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-ext-mailbox-mss-metadata)
...
Extension complexe: Extension contenant les métadonnées de la mailbox mss.
...
Autres représentations du profil : [CSV](../StructureDefinition-as-ext-mailbox-mss-metadata.csv), [Excel](../StructureDefinition-as-ext-mailbox-mss-metadata.xlsx), [Schematron](../StructureDefinition-as-ext-mailbox-mss-metadata.sch) 
