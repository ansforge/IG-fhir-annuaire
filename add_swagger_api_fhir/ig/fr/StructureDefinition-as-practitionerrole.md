# AS PractitionerRole Profile - Annuaire Santé v1.2.0-snapshot-3

## Profil de ressource: AS PractitionerRole Profile 

 
Profil générique créé à partir de FRCorePractitionerRole dans le contexte de l'Annuaire Santé pour décrire la situation d'exercice du professionnel. 

**Utilisations:**

* Dérivé de ce Profil: [AS Donnée Publique PractitionerRole Profile](StructureDefinition-as-dp-practitionerrole.md) and [AS Donnée Restreinte PractitionerRole Profile](StructureDefinition-as-dr-practitionerrole.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.annuaire|current/StructureDefinition/as-practitionerrole)
...
Cette structure est dérivée de [FRCorePractitionerRoleProfile](https://hl7.fr/ig/fhir/core/2.2.0/StructureDefinition-fr-core-practitioner-role.html) 
...
* [AS Practitioner Profile (https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitioner|1.2.0-snapshot-3)](StructureDefinition-as-practitioner.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-contracted|1.2.0-snapshot-3](StructureDefinition-as-ext-practitionerrole-contracted.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-hascas|1.2.0-snapshot-3](StructureDefinition-as-ext-practitionerrole-hascas.md)
* [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-vitale-accepted|1.2.0-snapshot-3](StructureDefinition-as-ext-practitionerrole-vitale-accepted.md)
...
* The element 2 is sliced based on the values of PractitionerRole.telecom
...
Autres représentations du profil : [CSV](../StructureDefinition-as-practitionerrole.csv), [Excel](../StructureDefinition-as-practitionerrole.xlsx), [Schematron](../StructureDefinition-as-practitionerrole.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-contracted|1.2.0-snapshot-3"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-hascas|1.2.0-snapshot-3"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-practitionerrole-vitale-accepted|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitioner|1.2.0-snapshot-3"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-organization|1.2.0-snapshot-3"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J94-GenreActivite-RASS/FHIR/JDV-J94-GenreActivite-RASS|20240329120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J95-ModeExercice-RASS/FHIR/JDV-J95-ModeExercice-RASS|20260202120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J96-TypeActiviteLiberale-RASS/FHIR/JDV-J96-TypeActiviteLiberale-RASS|20200424120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J97-StatutProfessionnelSSA-RASS/FHIR/JDV-J97-StatutProfessionnelSSA-RASS|20200424120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J98-StatutHospitalier-RASS/FHIR/JDV-J98-StatutHospitalier-RASS|20260223120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J108-EnsembleFonction-RASS/FHIR/JDV-J108-EnsembleFonction-RASS|20260505120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J73-MetierPharmacien-RASS/FHIR/JDV-J73-MetierPharmacien-RASS|20210528120000"
      },
      "mapping" : [{
        "identity" : "as-practitioner-role-to-mos-situation-exercice",
