# AS Donnée Publique PractitionerRole Profile - Annuaire Santé v1.2.0-snapshot-3
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.annuaire|current/StructureDefinition/StructureDefinition-as-dp-practitionerrole.json)
...
```json
{
  ...
  "baseDefinition" : "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitionerrole|1.2.0-snapshot-3",
