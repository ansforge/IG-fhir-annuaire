# AS Donnée Restreinte PractitionerRole Profile - Annuaire Santé v1.2.0-snapshot-3
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.annuaire|current/StructureDefinition/StructureDefinition-as-dr-practitionerrole.json)
