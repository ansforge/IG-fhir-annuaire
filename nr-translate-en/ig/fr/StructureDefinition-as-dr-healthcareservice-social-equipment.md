# AS Donnée Restreinte HealthcareService Social Equipment Profile - Annuaire Santé v1.2.0-snapshot-1
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 1,
      "max" : "1",
      "patternCanonical" : "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-dr-healthcareservice-social-equipment|1.2.0-snapshot-1"
    },
    {
