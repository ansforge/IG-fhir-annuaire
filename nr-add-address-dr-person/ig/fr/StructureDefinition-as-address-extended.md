...
* [http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-careOf|5.3.0](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-iso21090-ADXP-careOf.html)
* [http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-additionalLocator|5.3.0](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-iso21090-ADXP-additionalLocator.html)
* [http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-houseNumber|5.3.0](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-iso21090-ADXP-houseNumber.html)
* [http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-buildingNumberSuffix|5.3.0](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-iso21090-ADXP-buildingNumberSuffix.html)
...
Autres représentations du profil : [CSV](../StructureDefinition-as-address-extended.csv), [Excel](../StructureDefinition-as-address-extended.xlsx), [Schematron](../StructureDefinition-as-address-extended.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-careOf|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-additionalLocator|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
        "map" : "Adresse.complementPointGeographique"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-houseNumber|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-buildingNumberSuffix|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetNameType|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J103-TypeVoie-RASS/FHIR/JDV-J103-TypeVoie-RASS|20200424120000"
      }
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-postBox|5.3.0"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetNameBase|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "as-address-extended-to-mos-exercice-professionnel",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J256-Pays/FHIR/JDV-J256-Pays|20250328120000"
      }
    }]
  }
}
